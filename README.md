# 🗿 CHUD JS - Facial Analysis Engine
...
CHUD JS utilizes **MediaPipe Face Mesh** to map 468 distinct facial landmarks in real-time. It calculates complex geometric ratios—such as Canthal Tilt, FWHR, and Midface compactness—to provide an objective analysis of facial aesthetics directly in your browser at [chudjs.vercel.app](https://chudjs.vercel.app).
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=Jv91GEhY3nk">
    <img src="https://img.youtube.com/vi/Jv91GEhY3nk/0.jpg" alt="CHUD JS Facial Analysis Demo" width="100%">
  </a>
  <br>
...
```bash
git clone https://github.com/JaydenChan2/chud-js.git
cd chud-js
